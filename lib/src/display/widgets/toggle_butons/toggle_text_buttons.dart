...
class ToggleTextButtons extends StatefulWidget {
  ...
  @override
  _ToggleTextButtonsState createState() => _ToggleTextButtonsState();
}

class _ToggleTextButtonsState extends State<ToggleTextButtons> {
